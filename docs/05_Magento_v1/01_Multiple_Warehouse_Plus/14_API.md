On this page, we will describe how to manage product stocks for each warehouse with the SOAP API remotely. You will need an API user with approprite permissions.
